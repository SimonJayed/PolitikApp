...
public class AdminCurationController {
    ...
    /**
     * Fetch aggregated adjudication metrics for admin profile view.
     */
    @GetMapping("/adjudication/summary")
    public ResponseEntity<AdminCurationSummaryResponse> getAdjudicationSummary() {
        return ResponseEntity.ok(adminCurationService.getAdjudicationSummary());
    }
