  ...
  return (
    <main className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <section className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-slate-600">PolitikApp account access</p>
        ...
        <button className="mt-4 text-sm text-slate-700 underline" onClick={() => setMode((m) => (m === 'login' ? 'register' : 'login'))} type="button">
